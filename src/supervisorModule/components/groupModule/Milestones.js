...
const Milestones = () => {
  ...
  const [milestones, setMilestones] = useState([
    {
      ...
      assignedTo: 'Alice', // Assigning milestone to Alice by default
    },
  ...
  const [formData, setFormData] = useState({
    ...
    assignedTo: '', // New property for selecting student
  });
  ...
  const handleClose = () => {
    ...
    setFormData({
      ...
      points: '',
      fileSubmission: null,
      assignedTo: '', // Reset assignedTo value
    });
    setEditIndex(null);
  };
            ...
            {milestones.map((milestone, index) => (
              <Card key={index} className="mb-3">
                <Card.Body>
                  ...
                  <Card.Text>Description : {milestone.description}</Card.Text>
                  <Card.Text>
                  ...
                  <Card.Text>
                    <strong>Assigned To:</strong> {milestone.fileSubmission}
                  </Card.Text>
                  <div>
                    <Button
                      variant="warning"
